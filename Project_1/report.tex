...
\begin{figure}[H]
    \centering
    \subfloat[\centering Vanilla VAE]{{\includegraphics[width=8cm]{plots/VanillaVAE_10.pdf} }}%
    \qquad
    \subfloat[\centering VAE with custom decoder]{{\includegraphics[width=8cm]{plots/CustomVAE_10.pdf} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[\centering Vanilla VAE]{{\includegraphics[width=8cm]{plots/VanillaVAE_PCA_10.pdf} }}%
    \qquad
    \subfloat[\centering VAE with custom decoder]{{\includegraphics[width=8cm]{plots/CustomVAE_PCA_10.pdf} }}%
